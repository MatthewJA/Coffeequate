/* SLIGHTLY MODIFIED from the generated Jison grammar. Be wary when updating! */
...
define("require", function(require) {
    ...
    */
    ...
    function sub(l, r) {
        return add(l, mul("-1", r));
    };
    function div(l, r) {
        return mul(l, pow("-1", r));
    }
    ...
    break;
    case 6:this.$ = pow($$[$0-2],$$[$0]);
    break;
    case 7:this.$ = mul("-1",$$[$0]);
    break;
    case 8:this.$ = $$[$0-1];
    break;
    case 9:this.$ = stringToTerminal(yytext);
    break;
    }
    },
    ...
    exports.main = function commonjsMain(args){console.log(args);if(!args[1]){console.log("Usage: "+args[0]+" FILE");process.exit(1)}var source=require("fs").readFileSync(require("path").normalize(args[1]),"utf8");return exports.parser.parse(source)};
