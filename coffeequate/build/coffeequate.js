...
(function() {
  ...
  define('parse',["require"], function(require) {
    var CONSTANT_FLOAT_REGEX, CONSTANT_INTEGER_REGEX, DIMENSIONS_REGEX, ParseError, SYMBOLIC_CONSTANT_REGEX, VARIABLE_REGEX, parser, stringToTerminal;
    ...
    CONSTANT_FLOAT_REGEX = /^-?\d+(\.\d+)?(e-?\d+(\.\d+)?)?$/;
