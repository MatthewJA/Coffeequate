...
(function() {
  ...
  define('Equation',["terminals", "nodes", "operators", "parse"], function(terminals, nodes, operators, parse) {
    ...
    Equation = (function() {
      ...
      Equation.prototype.sub = function(substitutions, uncertainties, equivalencies, assumeZeroUncertainty, evaluate) {
        if (assumeZeroUncertainty == null) {
          assumeZeroUncertainty = false;
        }
        if (evaluate == null) {
        ...
        return new Equation(this.left, this.right.sub(substitutions, uncertainties, equivalencies, assumeZeroUncertainty, evaluate));
      };
