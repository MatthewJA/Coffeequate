...
(function() {
  ...
  define('parse',["require"], function(require) {
    var CONSTANT_REGEX, DIMENSIONS_REGEX, ParseError, RATIO_REGEX, SYMBOLIC_CONSTANT_REGEX, VARIABLE_REGEX, parser, stringToTerminal;
...
(function() {
  ...
  define('coffeequate',["operators", "Expression", "parse"], function(operators, Expression, parse) {
    return function() {
      var args, left, right, val, _ref;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      if (args.length === 1 && (typeof args[0] === "string" || args[0] instanceof String)) {
        if (/\=/.test(args[0])) {
          _ref = args[0].split("="), left = _ref[0], right = _ref[1];
